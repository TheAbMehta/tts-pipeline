...
\begin{itemize}[nosep]
    ...
    \item Inference latency: $<$\,200\,ms for a typical sentence
...
\begin{enumerate}
    ...
    \item \textbf{INT8 Quantization}: Dynamic INT8 quantization via \texttt{onnxruntime.quantization.quantize\_dynamic} reduces the model to $\sim$20\,MB, a $3\times$ compression with minimal quality degradation for TTS workloads.
...
\begin{tabular}{@{}llr@{}}
\toprule
\textbf{Target} & \textbf{Runtime} & \textbf{Latency} \\
\midrule
Browser & WASM & $<$200\,ms \\
Android/iOS & Mobile & $<$150\,ms \\
Raspberry Pi & ARM & $<$500\,ms \\
Desktop & ONNX RT & $<$50\,ms \\
\bottomrule
\end{tabular}
\caption{Deployment targets and expected latency ($\sim$10 words).}
